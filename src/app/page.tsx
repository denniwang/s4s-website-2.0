...
export default function Home() {
  ...
  const homePageJsonLd = {
    ...
    description:
      "Students4Students - Get expert college consulting for high schoolers. We help with essays, applications, and college prep.",
    url: "https://trys4s.com",
    keywords:
      "students4students, students 4 students, college consulting for high schoolers",
    mainEntity: {
      "@type": "Service",
      name: "College Consulting Services for High Schoolers",
      description:
        "Students4Students personalized college mentorship program with expert guidance for high school students applying to college",
      provider: {
  ...
  return (
    <>
      ...
      >
        <section
          className="h-[80vh] w-full relative bg-[url('/home/website-collage.jpeg')] lg:bg-[url('/home/website-collage-wide.jpeg')] bg-contain lg:bg-size-[40%]"
          style={{
          ...
          <div className="absolute top-0 right-0 w-full lg:w-3/4 h-full flex flex-col justify-center items-center text-center p-4 md:p-8">
            <header>
              ...
              <div className="sr-only">
                <h2>
                  Students 4 Students - College Consulting for High Schoolers
                </h2>
                <p>
                  Premier college consulting services for high school students.
                  Get expert help with college applications, essays, and
                  admissions guidance.
                </p>
              </div>
        ...
        <section aria-label="Student & Mentor Stories">
          <TestimonyGallery />
        </section>

...
export default function Formula() {
  return (
    <section className="flex flex-col gap-5 justify-center items-center bg-accent p-10 lg:w-[50vw]">
...
function ImageTextBlock() {
  return (
    <section className="flex flex-col lg:flex-row justify-around items-center lg:gap-2 bg-accent p-0 rounded-xl">
      <div className="relative lg:w-3/5 rounded-l-xl overflow-hidden lg:h-[30vh]">
...
function TextImageBlock() {
  return (
    <section className="flex flex-col lg:flex-row justify-around items-center lg:gap-2 bg-accent p-0 rounded-xl">
      <div className="block lg:hidden relative  rounded-l-xl overflow-hidden p-5 lg:h-[30vh]">
